...
export function TaskDetails({ task, knownTags, onSave, onCancel }: Props) {
  ...
  return (
    <div className="task-details" onKeyDown={handleRootKey}>
      ...
      <div className="task-details-actions">
        <button className="task-details-save" onClick={save}>
          save
        </button>
        <button className="task-details-cancel" onClick={onCancel}>
          cancel
        </button>
        <span className="task-details-hint">⌘↵ to save, esc to cancel</span>
      </div>
    </div>
  );
}
