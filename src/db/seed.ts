...
// Fully fictional. No real client names.
const TODAY = [
  { title: "Sketch onboarding flow for Atlas OS", tag: "#design", estimated_minutes: 60 },
...
const BACKLOG = [
  { title: "Draft Q3 review for the Lumen project", tag: "#write", estimated_minutes: 90 },
  { title: "Plan the Driftwood retreat agenda", tag: "#ops", estimated_minutes: 30 },
